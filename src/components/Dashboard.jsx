...
function Dashboard(props) {
    ...
    return (
        <div className='container'>
            <div className='dashboard-overview-bg px-8 pt-4 pb-8 mx-4'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-3 statistics'>
                <div className='col-span-1 flex flex-col mx-4 my-8 gap-8 justify-evenly drop-shadow-2xl'>
                ...
                <div className='col-span-2 chart-booking rounded-lg mx-4 my-8'>
                </div>
            </div>
        </div >
    );
        ...
        case 'bestTour':
            return (
                <div className='flex-1 flex flex-row'>
                    <div className='left-quick-report h-48 flex-1 flex flex-col items-center justify-center'>
                    ...
                    <div className='right-quick-report h-48 flex-1 flex flex-col items-center justify-center'>
...
function QuickOverview(props) {
    const generalOverviewClass = 'relative quick-overview flex-1 pb-4 pt-2 h-48 rounded-3xl shadow-xl cursor-pointer hover:translate-x-1 hover:-translate-y-1';
    let colorClass = '';
